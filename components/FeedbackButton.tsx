...
export default function FeedbackButton() {
  ...
  return (
    // Pinned to the bottom-right of the viewport (above BottomNav on mobile).
    <a
      href={WA_LINK}
      target="_blank"
      ...
      className="squishy-press fixed bottom-24 right-4 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_24px_rgba(37,211,102,0.4)] transition-transform hover:-translate-y-0.5"
    >
        <svg
          viewBox="0 0 24 24"
