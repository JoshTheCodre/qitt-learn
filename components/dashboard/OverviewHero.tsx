      ...
      <div className="relative overflow-hidden rounded-[22px] bg-gradient-to-br from-[#4d80bd] via-[#36669c] to-[#22406a] p-3.5 text-white shadow-[0_16px_36px_-14px_rgba(34,64,106,0.6)] ring-1 ring-inset ring-white/[0.14]">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between">
            {/* Not "For You" — nothing here is personalised. It's a fixed toolset, and
                naming it honestly reads more credible than a fake recommendation label. */}
            <h2 className="font-display text-[15px] font-bold leading-none">Study Tools</h2>
