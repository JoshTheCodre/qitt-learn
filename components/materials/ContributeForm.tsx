...
export default function ContributeForm() {
  ...
  if (submitted) {
    return (
      <div className="px-gutter pt-16 flex flex-col items-center text-center">
  ...
  return (
    <form onSubmit={handleSubmit} className="px-gutter pt-6 pb-32">
      ...
      <button
        ...
        className="mt-8 w-full flex flex-col items-center justify-center gap-4 rounded-3xl border-2 border-dashed border-outline-variant/60 bg-surface-container-lowest px-6 py-14 text-center hover:border-primary/40 transition-colors squishy-press"
      >
